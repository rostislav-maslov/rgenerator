...
<div class="row">
    <form action="<%= GeneratorAdminRoutes.ALL%>" method="GET">
        <div class="col-lg-5">
        ...
        <div class="table-responsive">
            <table class="table table-bordered" id="table-1">
                ...
                <tr>
                    ...
                    <th>User ID</th><th>Title</th><th>Description</th><th>Example</th><th>File Structure</th>
                    <th>Дата создания</th>
                ...
                <c:forEach items="${search.result}" var="doc">
                    <tr>
                        <td>${doc.userId}</td><td>${doc.title}</td><td>${doc.description}</td><td>${doc.example}</td><td>${doc.fileStructure}</td>
                        ...
                        <td>
                            <c:url value="<%= GeneratorAdminRoutes.EDIT%>" var="editUrl">
                            ...
                            <c:url value="<%= GeneratorAdminRoutes.DELETE%>" var="urlDelete">
                                <c:param name="id" value="${doc.id}"/>
                            </c:url>
...
<div class="row">
    <div class="col-lg-12 text-center">
        <ul class="pagination pagination-sm">
            <c:url value="<%= GeneratorAdminRoutes.ALL%>" var="urlPrev">
            ...
            <c:forEach items="${search.paginator()}" var="page">
                <c:url value="<%= GeneratorAdminRoutes.ALL%>" var="urlPage">
                    <c:param name="query" value="${search.query}"/>
            ...
            <c:url value="<%= GeneratorAdminRoutes.ALL%>" var="urlNext">
                <c:param name="query" value="${search.query}"/>
